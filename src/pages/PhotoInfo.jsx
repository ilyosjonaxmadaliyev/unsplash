...
function PhotoInfo() {
  ...
  const { data } = useAxios(
    `https://api.unsplash.com/search/photos?client_id=zcedffIShsDezHSOTBoM5yd0wPfMOea0rXS6rCFScow&per_page=1&query=${query}&id=${id}`
  );
      ...
      <div className="max-w-[1000px] mx-auto">
        <div className="carousel h-[570px]">
          ...
          <div id="item2" className="carousel-item w-full">
            <img src={data[0]?.urls?.raw} className="w-full my-auto h-[450px]" />
          </div>
